...
namespace Trend
{
    ...
    internal static class Win32
    {
        ...
        // Enums
        //
        #region[    ENUM : WindowStyles (WS_*, 윈도우스타일)    ]
        /// <summary>
        /// Window Styles.
        ...
        #endregion
        #region[    ENUM : HitTestValues (HT_*, 윈도우힛테스트밸류)    ]
        ...
        // Structures
        //
        #region[    STRUCT : NCCALCSIZE_PARAMS    ]
        ...
        // A bit of window ref
        //
        #region[    FUNC : WindowLong    ]
        [DllImport("user32")]
        public static extern int GetWindowLong(IntPtr hWnd, int nIndex);
        [DllImport("user32")]
        public static extern int SetWindowLong(IntPtr hWnd, int nIndex, int dwNewLong);
        #endregion
        #region[    FUNC : WindowPlacement (윈도우상태위치)    ]
        ...
        #endregion
        #region[    FUNC : SetWindowPos (윈도우상태위치 설정)    ]
        /// <summary>
        ...
        #endregion
        #region[    FUNC : GetForegroundWindow    ]
        [DllImport("user32")]
        public static extern IntPtr GetForegroundWindow();
        #endregion
        #region[    FUNC : SendMessage / PostMessage (윈도우메시징)    ]
        [DllImport("user32.dll")]
        ...
        #endregion
        #region[    FUNC : UpdateLayeredWindow    ]
        [DllImport("user32.dll")]
        ...
        // 윈도우 창 시스템 메뉴
        //
        #region[    FUNC : SystemMenu / PopupMenu    ]
        [DllImport("user32.dll")]
        ...
        #endregion
        //
        // A bit of mouse action
        //
        #region[    FUNC : ReleaseCapture    ]
        [DllImport("user32.dll")]
        public static extern bool ReleaseCapture();
        #endregion
        //
        // A bit of drawing context
        //
        #region[    FUNC : DC    ]
        [DllImport("user32.dll")]
